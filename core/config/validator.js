...
module.exports = {
  ...
  loginValidationRules: () => {
    return [body('email').trim().isLength({min: 5, max:60}), body('password').isLength({min: 5})];
  },
